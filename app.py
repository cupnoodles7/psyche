...
PAT = os.getenv("PAT") or st.secrets.get("PAT")
USER_ID = 'anthropic'
APP_ID = 'completion'
...
class VoiceAssistant:
    ...
    def generate_response(_self, user_message):
        ...
        try:
            ...
            Give answers as a mental health diagnosis response, if not reply 'I cannot answer that question'.
...
def init_styles():
    st.set_page_config(page_title="psyche", page_icon="🪼", layout="centered", initial_sidebar_state="collapsed")
